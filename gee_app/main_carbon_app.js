...
var panel = {
  title: ui.Label({
      value: 'Carbon Storage in Pakistan (1990-2020)',
      style: styleH1
  }),
  sec_panel:ui.Label({
  ...
  sub_title: ui.Label({
      value: 'Note: Select your Province/division and see the carbon storage rasters and total area',
      style: styleP
  }),
  provider: ui.Label({
      value: 'Cite :',
...
// area 1990
  ...
  download_link: ui.Label({
    value: 'Download Map Links :',
    style: {
        fontWeight: 'bold',
        fontSize: '12px',
        margin: '5px 5px 8px 5px',
