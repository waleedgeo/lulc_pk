...
Map.addLayer(img2020, lulcvis, 'PK LULC 2020', true)
...
sub_title: ui.Label({
    value: 'Note: Select your Province/division and see the LULC rasters and total area for each class.',
    style: styleP
}),
provider: ui.Label({
    value: 'Cite :',
...
district: ui.Select({
    ...
    onChange: function () {
        ...
        Map.addLayer(aoi_img2020, lulcvis, aoi_name + ' LULC 2020', true)
